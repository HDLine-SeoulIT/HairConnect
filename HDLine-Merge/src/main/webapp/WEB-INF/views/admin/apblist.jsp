...
<script  src="https://code.jquery.com/jquery-3.7.0.js"
    integrity="sha256-JlqSTELeR4TLqP0OG9dxM7yDPqX1ox/HfgsDLnl96nI=" 
    ...
    <form method="get" action="/modelboard/search">
        <table border="1" class="table table-hover"
            ...
            <tr>
                ...
                </select> <input type="text" name="keyword" /> <input type="submit"    value="검색하기" /></td>
            </tr>
        </table>
    </form>
    </div>
            ...
            <div class="row g-0">
                <div class="col-md-4" style="max-width: 300px;">
                    <div style="width:200px; height: 200px; overflow: hidden">
                        <img src="/img/long.jpg" class="img-fluid img-thumbnail rounded-start" alt="...">
                    </div>
                </div>
                <div class="col-md-8">
                    <div class="card-body">
