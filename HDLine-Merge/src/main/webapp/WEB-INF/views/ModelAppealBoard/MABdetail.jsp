		...
		<tr>
			<td colspan="2" align="center">
				<c:if test="${userno == post.user.no}">
			        		<a href="/modelboard/${post.MABno}/updateform" class="btn btn-light">수정</a>
			        		<a href="/modelboard/${post.MABno}/delete" class="btn btn-danger" id="delete">삭제</a>
	        	</c:if>
				<button class="btn btn-light sm" type="button" onclick="location.href='/modelboard/list/'">목록으로 돌아가기</button>
			</td>
		</tr>
	</table>		
	</form>
