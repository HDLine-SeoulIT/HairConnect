...
<div style="align-content: center;">
   <form method="get" action="/modelboard/search">
...
<%--         </c:if> --%>
        <c:if test="${not empty boardPage.content}">
            <ul class="pagination" style="align-self: center;">
                <c:choose>
                    <c:when test="${boardPage.number > 0}">
                        <li><a href="?searchField=${searchField }&keyword=${keyword}&page=0">First</a></li>
                        <li><a href="?searchField=${searchField }&keyword=${keyword}&page=${boardPage.number - 1}">Previous</a></li>
                    </c:when>
                    <c:otherwise>
                        <li class="disabled"><span>First</span></li>
                        <li class="disabled"><span>Previous</span></li>
                ...
                <c:forEach begin="0" end="${boardPage.totalPages - 1}" varStatus="i">
                    <c:choose>
                        ...
                        <c:otherwise>
                            <li><a href="?searchField=${searchField }&keyword=${keyword}&page=${i.index}">${i.index + 1}</a></li>
                        </c:otherwise>
                    </c:choose>
                </c:forEach>
                ...
                <c:choose>
                    <c:when test="${boardPage.number < boardPage.totalPages - 1}">
                        <li><a href="?searchField=${searchField }&keyword=${keyword}&page=${boardPage.number + 1}">Next</a></li>
                        <li><a href="?searchField=${searchField }&keyword=${keyword}&page=${boardPage.totalPages - 1}">Last</a></li>
                    </c:when>
                    <c:otherwise>
                        <li class="disabled"><span>Next</span></li>
                        <li class="disabled"><span>Last</span></li>
