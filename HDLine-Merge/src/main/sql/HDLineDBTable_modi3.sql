...
DROP TABLE DesignerAppealBoard CASCADE CONSTRAINTS;
...
CREATE TABLE DesignerAppealBoard
(
...
ALTER TABLE DesignerAppealBoard
	ADD FOREIGN KEY (no)
...
COMMENT ON COLUMN DesignerAppealBoard.no IS '회원번호';
COMMENT ON COLUMN DesignerAppealBoard.region IS '지역';
